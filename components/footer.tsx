...
export function Footer() {
  return (
    <footer className="relative overflow-hidden text-white border-t border-white/10 py-12 px-4 sm:px-6 lg:px-8 bg-[url('/footer.jpeg')] bg-cover bg-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <div className="flex items-start gap-2 text-sm text-white/70">
              ...
              <span className="text-[color-mix(in srgb,var(--aluminum) 85%, var(--accent) 15%)]">
