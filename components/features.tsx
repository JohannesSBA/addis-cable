...
export function Features() {
  ...
  const layout = ['lg:col-span-2', 'lg:col-span-1', 'lg:col-span-1', 'lg:col-span-2', 'lg:col-span-1', 'lg:col-span-1']

  return (
    <section id="about" className="relative py-28 px-4 sm:px-6 lg:px-8 bg-[#03040a] text-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        >
          <p className="uppercase tracking-[0.4em] text-xs text-white/50">Capabilities</p>
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-xs uppercase tracking-[0.4em] text-white/40">{String(index + 1).padStart(2, '0')}</span>
              </div>
