    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto space-y-12">
        <div className="max-w-3xl space-y-4">
          <p className="uppercase tracking-[0.4em] text-xs text-slate-500">Output Signals</p>
          ...
          <p className="text-lg text-slate-600">
            Precision factories, redundant lines, and future-proofed chemistries keep Addis Cable delivering when infrastructure can’t stall.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-[1.1fr,0.9fr] gap-8">
          ...
          >
            ...
            <div className="relative">
              <p className="text-sm uppercase tracking-[0.4em] text-slate-500 mb-6">Core Throughput</p>
              <div className="flex flex-col gap-6">
                ...
                <p className="text-2xl font-semibold text-slate-900">{heroStat.label}</p>
                ...
                <div className="mt-4 grid grid-cols-3 gap-4 text-center">
                  {['Copper Rod', 'Aluminum', 'Hybrid'].map((item, index) => (
                    ...
                    >
                      ...
                      <p className="text-lg font-semibold text-primary/80">{['9,109t', '4,727t', 'Rapid'][index]}</p>
                    </motion.div>
                  ))}
                </div>
              </div>
            ...
            >
              <p className="text-xs uppercase tracking-[0.4em] text-slate-400 mb-1">Dispatch</p>
              <p className="text-lg font-semibold text-slate-900">72 hr</p>
              <p className="text-xs text-slate-500">Avg. regional delivery window</p>
            </motion.div>
          </motion.div>
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {otherStats.map((stat, index) => (
              ...
              >
                <p className="text-xs uppercase tracking-[0.4em] text-slate-400 mb-6">{stat.label}</p>
                <p className="text-4xl font-bold text-primary mb-3">{stat.value}</p>
            ...
            >
              <p className="text-xs uppercase tracking-[0.4em] text-slate-500 mb-4">Regional Footprint</p>
              <p className="text-slate-700">
                Service corridors span Ethiopia, Kenya, Djibouti, Tanzania, and emerging Sahel electrification programs with on-ground technical teams.
              </p>
            </motion.div>
          </div>
        </div>
