        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {partners.map((partner) => (
              <div key={partner} className="bg-muted/50 rounded-xl p-6 border border-border text-center">
        ...
        <div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {advantages.map((advantage) => (
              <div key={advantage.title} className="bg-card border border-border rounded-xl p-6 hover:border-copper/50 transition-colors">
