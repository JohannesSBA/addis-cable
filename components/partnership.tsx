  ...
  const advantages = [
    {
      ...
      description:
        "Gelan Industrial Zone hub with proximity to Ethiopia's mega projects",
    },
    {
      icon: "⚡",
    ...
    >
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <p className="text-slate-600 text-center max-w-3xl mx-auto mb-12 leading-relaxed">
          Our Gelan factory offers an investment platform that combines local
          market access, logistics proximity, favorable tax policies, and a
          skilled workforce ready to deliver world-class cables for Ethiopia's
          growth.
        </p>
